...
class ProfilePage(QWidget):
    ...
    def init_ui(self):
        ...
        curr = QLineEdit()
        curr.setPlaceholderText("Current password")
        curr.setEchoMode(QLineEdit.EchoMode.Password)
        sc_layout.addWidget(curr)
        newp = QLineEdit()
        newp.setPlaceholderText("New password")
        newp.setEchoMode(QLineEdit.EchoMode.Password)
        sc_layout.addWidget(newp)
        pwd_btn = QPushButton("Change Password")
        pwd_btn.setObjectName("secondaryBtn")
        sc_layout.addWidget(pwd_btn)
